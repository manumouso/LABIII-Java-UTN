...
public class Invite extends HttpHandlers {
    public Invite(ServiceManager serviceManager) {
    ...
    public void handle(HttpExchange exchange) throws IOException {
        ...
        if (requestMethod.equalsIgnoreCase(Constants.POST)) {
            ...
            String answer=serviceManager.invitationReceived();
            if(answer.equals("Connection accepted by the client")){
                serviceManager.setInvitationAccepted(true);
            }
