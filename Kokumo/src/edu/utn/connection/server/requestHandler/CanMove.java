...
public class CanMove extends HttpHandlers {
    public CanMove(RuleManager ruleManager) {
        super(ruleManager);
    }
    ...
    public void handle(HttpExchange exchange) throws IOException {
        ...
        if (requestMethod.equalsIgnoreCase(Constants.POST)) {
            ...
            boolean commanderDead=object.getBoolean("commanderDead");
            int attackCounter=object.getInt("attackCounter");
            int moveCounter=object.getInt("moveCounter");
            boolean movedPreviousTurn = object.getBoolean("movedPreviousTurn");
            boolean ninjaDead= object.getBoolean("ninjaDead");

            String message = ruleManager.canMoveClient(commanderDead,attackCounter,moveCounter,movedPreviousTurn,ninjaDead);
